        ...
        <div class="col-md-12">
            <div class="panel panel-default globalpanel">
                ...
                <div class="panel-body">
					<form method="get" action="/brainstorm" style="margin:auto;text-align:center;max-width:300px;">
						...
						<br/>
						<span style="font-size: 21px;"><?php echo __("messages.Cards to find");?></span>
						<br/>
