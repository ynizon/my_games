                ...
                <div class="panel-body">
					...
					<a href='/login'><?php echo __("messages.Connection");?></a>
						...
						<ul class="share-buttons">
						  ...
						  <li><a href="https://x.com/intent/tweet?source=<?php echo config("app.url");?>&text=<?php echo config("app.name");?>:%20<?php echo config("app.url");?>&via=enpix" target="_blank" title="Tweet"><img alt="Tweet" src="images/social_flat_rounded_rects_svg/Twitter.svg" /></a></li>
