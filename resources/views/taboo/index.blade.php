    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default globalpanel" style="text-align:center">
                <div class="panel-heading">Taboo - <?php echo __("messages.Set");?> <span class="step">1</span>&nbsp;&nbsp;&nbsp;<span id="spanpause" class="inv" ><i onclick="pause()" id="btn_pause" class="fa fa-pause pointer" ></i></span></div>

                <div class="panel-body" >
					<div id="intro" class="intro slider">
						<h1><?php echo __("messages.Lookfor");?> <span class="step">1</span>/<?php echo $nbsets;?></h1>
						<p><?php echo __("messages.goal_taboo");?>.						
						</p>
						<br/>
