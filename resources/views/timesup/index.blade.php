    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default globalpanel" style="text-align:center">
                <div class="panel-heading">Time's up - <?php echo __("messages.Set");?> <span class="step">1</span>&nbsp;&nbsp;&nbsp;<span id="spanpause" class="inv" ><i onclick="pause()" id="btn_pause" class="fa fa-pause pointer" ></i></span></div>
                ...
                <div class="panel-body" >
					<div id="intro1" class="intro slider">
						<h1><?php echo __("messages.Describe");?> !</h1>
						<p><?php echo __("messages.goal_timesup1");?>.
						</p>
						<br/>
						<input onclick="startSet(1)" type="button" value="<?php echo __("messages.Team 1 Start");?>" class="btnstep btn btn-primary" />
					</div>
	
					<div id="intro2" class="intro inv">
						<h1><?php echo __("messages.Oneword");?> !</h1>
						<p><?php echo __("messages.goal_timesup2");?>.
						</p>
						<br/>
						<input onclick="startSet(2)" type="button" value="<?php echo __("messages.Team 1 Start");?>" class="btnstep btn btn-primary" />
					</div>
					
					<div id="intro3" class="intro inv">
						<h1><?php echo __("messages.Mime");?> !</h1>
						<p><?php echo __("messages.goal_timesup3");?>.
						<p>.
						</p>
						<br/>
						<input onclick="startSet(3)" type="button" value="<?php echo __("messages.Team 1 Start");?>" class="btnstep btn btn-primary" />
					</div>
					...
					<div id="endinggame" class="inv timesup">
						<div>
							...
							<p><span id="score">0</span><br/>
								<input onclick="initGame()" type="button" value="<?php echo __("messages.Next Team");?>" class="pointer btnstep btn btn-primary" /><br/>
					...
					<div id="endingset" class="inv timesup">
						<div>
							...
							<table class="table table-striped">
								...
								<tbody>
									<tr>
										<td><?php echo __("messages.Set");?> 1</td>
									...
									<tr>
										<td><?php echo __("messages.Set");?> 2</td>
									...
									<tr>
										<td><?php echo __("messages.Set");?> 3</td>
						...
						<div id="finish">
							<input onclick="nextSet()" type="button" value="<?php echo __("messages.Next Set");?>" class="pointer btnstep btn btn-primary" />
						</div>
					...
					<script>
						...
						function endGame(){
							...
							arrCardsTeam.forEach (function(item){
								...
								sList = sList+ '<li class="pointer list-group-item list-group-item-'+sInfo+'"><span onclick="changeThis(this)">'+item.name+'</span>&nbsp;&nbsp;&nbsp;<a target="biography" href="https://<?php echo explode("_",$_COOKIE["locale"])[0];?>.wikipedia.org/wiki/'+biography(item.name)+'"><i class="fa fa-link"></i></a></li>';
							});
							$("#list").html(sList);
							$("#spanpause").hide();
							$("#endinggame").show();
