			...
			<td>
				...
				<div style="" class="tc myborderround" >
					<table class="mytable" width="100%">
						...
						?>
							<tr>
								<td class='tc'><span style="font-size:18px;" id="word_<?php echo $i;?>"></span></td>
							</tr>
						<?php
						}
						?>
...
<script>
	...
	?>
		...
		cards1.push("<?php echo htmlspecialchars($card->word1);?>");
		cards2.push("<?php echo htmlspecialchars($card->word2);?>");
		cards3.push("<?php echo htmlspecialchars($card->word3);?>");
		cards4.push("<?php echo htmlspecialchars($card->word4);?>");
		cards5.push("<?php echo htmlspecialchars($card->word5);?>");
